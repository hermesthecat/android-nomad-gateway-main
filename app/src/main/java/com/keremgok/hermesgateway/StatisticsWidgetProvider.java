...
public class StatisticsWidgetProvider extends AppWidgetProvider {
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        try {
            ...
            views.setTextViewText(R.id.widget_success_rate, DeliveryStatistics.formatSuccessRate(statistics.getOverallSuccessRate()));
    ...
    public static String getWidgetDebugInfo(Context context) {
        try {
            ...
            info.append("Current stats - Webhook: ").append(statistics.getWebhookSuccessCount())
                ...
                .append(", Success Rate: ").append(DeliveryStatistics.formatSuccessRate(statistics.getOverallSuccessRate()));
